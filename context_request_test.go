...
func (s *ContextRequestSuite) SetupTest() {
	...
	s.mockConfig.EXPECT().GetInt("http.drivers.chi.body_limit", 4096).Return(4096).Once()
...
func (s *ContextRequestSuite) TestAll_PostWithJson() {
	...
	s.Equal("{\"age\":1,\"all\":{\"Age\":1,\"Name\":\"goravel\",\"a\":\"1,2\",\"name\":\"3\"},\"name\":\"goravel\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestAll_PostWithErrorJson() {
	...
	s.Equal("{\"age\":0,\"all\":{\"a\":\"1,2\",\"name\":\"3\"},\"name\":\"\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestBindQueryToStruct() {
	...
	s.Equal("{\"id\":\"2\",\"persons\":[{\"name\":\"John\",\"age\":30},{\"name\":\"Doe\",\"age\":40}]}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestBind_ThenInput() {
	...
	s.Equal("{\"name\":\"Goravel\",\"name1\":\"Goravel\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestFile() {
	...
	s.Equal("{\"exist\":true,\"extension\":\"txt\",\"file_path_length\":14,\"hash_name_length\":44,\"hash_name_length1\":49,\"original_extension\":\"md\",\"original_name\":\"README.md\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestMethods() {
	...
	s.Equal("{\"full_url\":\"\",\"header\":\"Goravel\",\"id\":\"1\",\"ip\":\"\",\"method\":\"GET\",\"name\":\"Goravel\",\"path\":\"/methods/1\",\"url\":\"\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestInput_Json() {
	...
	s.Equal("{\"id\":\"3\",\"int\":\"1,2\",\"map\":\"{\\\"a\\\":\\\"b\\\"}\",\"string\":\"string 1,string 2\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestInput_Form() {
	...
	s.Equal("{\"id\":\"4\",\"map\":\"{\\\"a\\\":\\\"b\\\"}\",\"string\":\"string 1,string 2\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestInput_NestedJson() {
	...
	s.Equal("{\"id\":\"{\\\"b\\\":\\\"c\\\"}\",\"string\":\"string 0,string 1\",\"string0\":\"string 0\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestInput_NestedForm() {
	...
	s.Equal("{\"name\":\"goravel\",\"string\":\"string 0,string 1\",\"string0\":\"string 0\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestInput_NestedUrl() {
	...
	s.Equal("{\"id\":\"4\",\"string\":\"string 0,string 1\",\"string0\":\"string 0\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestInputArray_Form() {
	...
	s.Equal("{\"InputArray\":[\"arr 1\",\"arr 2\"],\"InputArray1\":[\"arr 1\",\"arr 2\"]}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestInputArray_Url() {
	...
	s.Equal("{\"string\":[\"string 0\",\"string 1\"],\"string1\":[\"string 0\",\"string 1\"]}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestInputBool() {
	...
	s.Equal("{\"id1\":true,\"id2\":true,\"id3\":true,\"id4\":true,\"id5\":false}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestQuery() {
	...
	s.Equal("{\"bool1\":true,\"bool2\":true,\"bool3\":true,\"bool4\":true,\"bool5\":false,\"error\":0,\"int\":1,\"int64\":2,\"int64_default\":22,\"int_default\":11,\"string\":\"Goravel\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestQueryMap() {
	...
	s.Equal("{\"name\":{\"a\":\"Goravel\",\"b\":\"Goravel1\"}}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestQueries() {
	...
	s.Equal("{\"all\":{\"bool1\":\"1\",\"bool2\":\"true\",\"bool3\":\"on\",\"bool4\":\"yes\",\"bool5\":\"0\",\"error\":\"a\",\"int\":\"1\",\"int64\":\"2\",\"string\":\"Goravel\"}}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestRoute() {
	...
	s.Equal("{\"error\":0,\"int\":2,\"int64\":3,\"string\":\"1\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestSession() {
	...
	s.Equal("{\"message\":\"goravel_session\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestSession_NotSet() {
	...
	s.Equal("{\"message\":\"session not set\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestValidate_PostSuccess() {
	...
	s.Equal("{\"age\":\"2\",\"id\":\"1\",\"name\":\"Goravel\",\"uuid\":\"3\"}\n", body)
	s.Equal(http.StatusOK, code)
}
...
func (s *ContextRequestSuite) TestValidateRequest_FormSuccess() {
	...
	s.Equal("{\"file\":\"README.md\",\"image\":\"logo.png\",\"json\":\"{\\\"age\\\": 1, \\\"name\\\": \\\"Bowen\\\"}\",\"name\":\"Goravel\"}\n", body)
	s.Equal(http.StatusOK, code)
}
